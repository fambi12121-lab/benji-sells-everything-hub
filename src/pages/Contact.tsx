      ...
      <section className="relative pt-28 md:pt-36 pb-14 md:pb-20 px-4 md:px-8 lg:px-16 overflow-hidden bg-background">
        ...
        <div className="container mx-auto relative">
          ...
          <motion.h1
            ...
            className="font-heading text-[clamp(2.75rem,11vw,8rem)] leading-[0.92] text-balance max-w-4xl"
          >
          ...
          <motion.p
            ...
            className="drop-cap mt-6 md:mt-8 max-w-xl text-base md:text-lg text-muted-foreground leading-relaxed"
          >
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10">
            ...
            <motion.form
              ...
              className="lg:col-span-7 bg-card border border-border rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-soft space-y-5 md:space-y-6"
            >
              <div>
                <p className="eyebrow mb-2">01 — Your details</p>
                <h2 className="font-heading text-2xl md:text-4xl">Tell us about <span className="italic text-primary">you</span>.</h2>
              </div>
            ...
            >
              <div className="bg-card border border-border rounded-2xl md:rounded-3xl p-6 md:p-8">
                <p className="eyebrow mb-2">02 — Reach us</p>
                <h3 className="font-heading text-2xl md:text-3xl mb-6 md:mb-8">Direct <span className="italic text-primary">channels</span>.</h3>
              ...
              <a
                ...
                className="group flex items-center justify-between gap-4 dark-section rounded-2xl md:rounded-3xl p-6 hover:opacity-95 transition-opacity"
              >
